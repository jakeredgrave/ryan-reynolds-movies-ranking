...
function App() {
  const [moviesList, setMoviesList] = useState([
    ...
    },
    {
      ...
      myRemarks:
        "Absolutely incredible acting by Ryan Reynolds; the way he just flips the switch and makes his character absolutely intimidating and scary in a matter of seconds is crazy. On top of that, the movie has this special thing going on with the colors; usually we see the world the same way as protagonist, so it's colorful and clean, but on a few occasions we're allowed to see how it looks in reality. The final credits are also something that's worth mentioning, as they leave you asking 'what the hell just happened' - trust me.",
      cover: cover2,
      rating: 10,
    },
    {
      ...
      description:
        "Guy goes back to the future to find his girlfriend, but instead he meets his younger self. Now they have to work together to save her and fix everything that was messed up with time, by the woman who was a co worker of their (his, I guess, since they both are the same person) deceased father.",
      myRemarks:
    ...
    },
    {
      ...
      myRemarks:
        "Ryan is a perfect Deadpool and that's a fact, but the story and the way it's told, unfortunately isn't. For some reason we jump in time to different moments and it really doesn't work well for the movie in my opinion. Most side characters are kinda boring, not to mention the bad guy. He could not exist and it wouldn't change a thing.",
      cover: cover5,
      rating: 6,
    },
    {
    ...
    },
    {
      ...
      title: "The Change-Up",
      description:
        "Guy and his friend are tired of their own lives and wish to have life of the other one, while doing so, they pee into a fountain, during which a blackout occurs. Next morning, they wake up in each other's bodies and have to face each other's problems.",
      myRemarks:
        "Movie isn't innovative, but it does it's job well. A bit too long, because each character took too much time to go through some inner change, by living in the body of the other one. Although, in the end, they do actually gain some new perspective, which helps them to appreciate their own lives way more.",
      cover: cover8,
      rating: 7,
    },
  ]);
  ...
  // Returns movie with given ID as an object
